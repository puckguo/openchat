# OpenCode Chat - Project Launch SOP

Standard Operating Procedure for launching and maintaining the OpenCode Chat project.
...
3. **Launch Post**
   ...
   ## Headline
   Excited to announce OpenCode Chat v1.0 - Open-source AI chat platform!
