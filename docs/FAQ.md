...
Frequently asked questions about OpenCode Chat deployment, usage, and troubleshooting.
...
OpenCode Chat is an open-source multiplayer chat platform with integrated AI capabilities. Unlike traditional chat apps, it includes an AI assistant that can read files, execute commands, and collaborate with team members in real-time.

### What makes OpenCode Chat different from Slack or Discord?
...
### Is OpenCode Chat free?

Yes! OpenCode Chat is open-source under the MIT license. You can use it for free, modify it, and even host it commercially.
...
OpenCode Chat can be deployed on:
- AWS (EC2, ECS, Lambda)
...
Currently, OpenCode Chat supports:
...
### Is OpenCode Chat secure?

OpenCode Chat includes several security features:
...
### How many concurrent users can OpenCode Chat handle?
...
### How much bandwidth does OpenCode Chat use?
